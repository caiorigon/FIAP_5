                ...
                Flexible(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(widget.component.threat.threatType ?? ""),
                      SizedBox(height: 8),
                      Divider(height: .5),
                      SizedBox(height: 8),
                      Text(
...
class ThreatIcon extends StatelessWidget {
  const ThreatIcon({super.key, required this.widget});

  final ExpandableComponentWidget widget;
